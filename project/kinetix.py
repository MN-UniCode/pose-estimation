...
from body_landmarks import BodyLandmarks, BodyLandmarkGroups
import masses
...
while True:
    ...
    ke_graph_image = draw_cv_graph(ke_history, annotated_image.shape[1], annotated_image.shape[0], max_ke, fps,
                                   plot_window_seconds, "Kinetic Energy")
